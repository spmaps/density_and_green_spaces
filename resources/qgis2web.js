      ...
      map.getView().fit([-74993.117565, 6676910.463863, 47437.281606, 6749914.550593], map.getSize());

      var NO_POPUP = 0
      var ALL_FIELDS = 1

      popupLayers = ["land-area-population-density-lsoa11_People_per_Sq_Km",0,0];
